...
def main():
    ...
    X_train_scaled = scaler.fit_transform(X_train.reshape(-1, 224*224)).reshape(X_train.shape + (1,))
    X_test_scaled = scaler.transform(X_test.reshape(-1, 224*224)).reshape(X_test.shape + (1,))
